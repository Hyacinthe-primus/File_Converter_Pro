...
from app.mixins.compression import CompressionMixin  # noqa: E402
from app.mixins.image_to_pdf import ImageToPdfMixin  # noqa: E402
from app.mixins.optimization import OptimizationMixin  # noqa: E402
from app.mixins.pdf_operations import PdfOperationsMixin  # noqa: E402
from app.mixins.pdf_to_word import PdfToWordMixin  # noqa: E402
from app.mixins.word_to_pdf import WordToPdfMixin  # noqa: E402


class AppLogicMixin(
    OptimizationMixin, ImageToPdfMixin, BatchMixin, PdfOperationsMixin, PdfToWordMixin, WordToPdfMixin, CompressionMixin
):
    ...
    def __init__(self, config_manager):
        ...
        if _argv_project:
            ...
            self.config.get("auto_open_last_project") and self.current_project and os.path.exists(self.current_project)
        ):
    ...
    def show_terms_dialog(self):
        ...
        if result == QDialog.Accepted:
            ...
            QMessageBox.information(
                ...
                self.translate_text(
                    "Vous devez accepter les conditions d'utilisation et la politique de confidentialité pour utiliser cette application."  # noqa: E501
                ),
            )
            sys.exit(0)
