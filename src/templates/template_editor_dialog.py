...
class TemplateEditorDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        config_text = self.parent_dialog.format_config_for_display(self.template["config"], self.template["type"])
        ...
        note_label = QLabel(
            self.parent_dialog.translate_text(
                "Note: L'édition avancée de la configuration sera disponible dans une future version."
            )
        )
