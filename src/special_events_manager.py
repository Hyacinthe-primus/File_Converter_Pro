...
def _resource_path(relative: str) -> str:
    ...
    for alt in (Path.cwd() / relative, SRC_DIR / relative):
        if alt.exists():
            return str(alt)
...
class SpecialEventsManager:
    ...
    def _fire_new_year(self):
        ...
        popup = SpecialEventPopup(
            ...
            sound_path=_resource_path(os.path.join("SFX", "new_year.ogg")),
    ...
    def _fire_birthday(self, age: int):
        ...
        popup = SpecialEventPopup(
            ...
            sound_path=_resource_path(os.path.join("SFX", "birthday.ogg")),
